...
data = load('TrainTest1456_2.mat');

TrainInputs = data.Train_set1456_2(:,1:20);
TrainTargets = data.Train_set1456_2(:,21);

TestInputs = data.Test_set1456_2(:,1:20);
TestTargets = data.Test_set1456_2(:,21);
...
m = matfile('TrainTest1456_2.mat','Writable',true);
m.fis2=fis2;
%% Plot Results
