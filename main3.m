...
data = load('TrainTest1456_3.mat');

TrainInputs = data.Train_set1456_3(:,1:20);
TrainTargets = data.Train_set1456_3(:,21);

TestInputs = data.Test_set1456_3(:,1:20);
TestTargets = data.Test_set1456_3(:,21);
...
m = matfile('TrainTest1456_3.mat','Writable',true);
m.fis3=fis3;
%% Plot Results
