...
data = load('TrainTest1456_4.mat');

TrainInputs = data.Train_set1456_4(:,1:20);
TrainTargets = data.Train_set1456_4(:,21);

TestInputs = data.Test_set1456_4(:,1:20);
TestTargets = data.Test_set1456_4(:,21);
...
m = matfile('TrainTest1456_4.mat','Writable',true);
m.fis4=fis4;
%% Plot Results
